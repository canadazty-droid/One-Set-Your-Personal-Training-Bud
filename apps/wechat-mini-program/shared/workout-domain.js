// Generated from packages/workout-domain/index.mjs. Do not edit directly.
const EXERCISES = {
  chest: [
...
function parseWorkoutIntent(rawInput = "") {
...
function generateWorkoutFromIntent(intent = {}, profile = {}, seed = Date.now()) {
...
function cryptoRandomId() {
  if (typeof crypto !== 'undefined' && crypto.randomUUID) return globalThis.crypto.randomUUID();
...
function parseImportedPlan(rawInput = "") {
  const raw = String(rawInput).trim();
...
function parseNaturalLanguageLog(rawInput = "") {
...
function summarizeCompletedWorkout(workout, completedSets = [], previousVolume = 0) {
...
module.exports = { parseWorkoutIntent, generateWorkoutFromIntent, parseImportedPlan, parseNaturalLanguageLog, summarizeCompletedWorkout, EXERCISES, GROUP_LABELS };
